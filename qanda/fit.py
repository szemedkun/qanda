...
class Fit(object):
	...
	def compile_layers(self):
		...
		# statements lstm
		sentrnn = Sequential()
		sentrnn.add(RNN(self.W2V_DIM, self.SENT_HIDDEN_SIZE, return_sequences=False))

		# query lstm
		qrnn = Sequential()
		qrnn.add(RNN(self.W2V_DIM, self.QUERY_HIDDEN_SIZE, return_sequences=False))
...
if __name__ == "__main__":
	ds = Datasets(task_index = 1, only_supporting = True)
	ds.fit()
